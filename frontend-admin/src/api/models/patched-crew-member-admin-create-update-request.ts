 ...
 *
 * @export
 * @interface PatchedCrewMemberAdminCreateUpdateRequest
 */
export interface PatchedCrewMemberAdminCreateUpdateRequest {
  /**
   *
   * @type {number}
   * @memberof PatchedCrewMemberAdminCreateUpdateRequest
   */
  member?: number;
  /**
   *

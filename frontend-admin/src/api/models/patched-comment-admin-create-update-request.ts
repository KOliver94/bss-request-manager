 ...
 *
 * @export
 * @interface PatchedCommentAdminCreateUpdateRequest
 */
export interface PatchedCommentAdminCreateUpdateRequest {
  /**
   *
   * @type {boolean}
   * @memberof PatchedCommentAdminCreateUpdateRequest
   */
  internal?: boolean;
  /**
   *

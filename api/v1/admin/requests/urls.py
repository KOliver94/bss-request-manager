...
urlpatterns = [
    ...
    path('requests/<int:request_id>/comments/<int:pk>', CommentAdminDetailView.as_view()),
    path('requests/<int:request_id_comment>/comments/<int:pk>/history', HistoryRetrieveView.as_view()),
    ...
    path('requests/<int:request_id_video>/videos/<int:pk>/history', HistoryRetrieveView.as_view()),
    path('requests/<int:request_id>/videos/<int:video_id>/ratings', RatingAdminListCreateView.as_view()),
    path('requests/<int:request_id>/videos/<int:video_id>/ratings/<int:pk>', RatingAdminDetailView.as_view()),
    path('requests/<int:request_id>/videos/<int:video_id>/ratings/<int:pk>/history', HistoryRetrieveView.as_view()),
]

...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(FRONTEND_DIR, 'build'), os.path.join(BACKEND_DIR, 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [os.path.join(FRONTEND_DIR, 'build', 'static'), os.path.join(BACKEND_DIR, 'templates', 'static')]
